...
//	private static final int height = 1000;
	...
	private void drawHorizontalGridLines(Graphics g) {
		...
		/*
		 * Get Y-Values for first upper and lower GridLines Add/Sub dy to
		 * prevent drawing the axis twice Start painting GridLines from the
		 * middle
		 */
	...
	private void drawAxis(Graphics g) {
		/*
		 * Convert to Graphics2D object to set StrokeWidth of Axis. This is
		 * OPTIONAL
		 */
		...
		// int[] xb = {height / 2,(height / 2) - (arrowWidth / 2),(height / 2) +
		// (arrowWidth / 2),height / 2};
		// // Create Point arrays for yArrowHead
		// int[] ya = {width / 2, (width / 2) - (arrowWidth / 2),(width / 2) +
